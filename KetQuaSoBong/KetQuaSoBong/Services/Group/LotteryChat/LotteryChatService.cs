...
{
    public class LotteryChatService : ILotteryChatService
    {
        ...
        {
            string url = "https://api.tructiepketqua.net/api/Chats/XoSo/" + item.UserName + "/" + item.Name + "?message=" + item.Message;
